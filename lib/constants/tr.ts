...
export const TR = {
  ...
  expenseCategories: {
    ...
    AYLIK_CIFTLIK_GIDERLERI: 'Aylık Çiftlik Giderleri',
  ...
  dashboard: {
    registrations: 'Son Kayıtlar & Deklareler',
    gallops: 'Son İdmanlar',
    recentRaces: 'Son Koşular',
    recentExpenses: 'Son Giderler & Notlar',
    kayit: 'Kayıt',
    deklare: 'Deklare',
