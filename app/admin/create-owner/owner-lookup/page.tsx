...
/**
 * Admin onboarding: Owner lookup page
 * Uses exact same design as original onboarding page
 */
export default function AdminOwnerLookupPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/admin/onboarding/owner-profile', {
        method: 'POST',
        headers: {
      ...
      router.replace('/admin/create-owner/stablemate-setup')
